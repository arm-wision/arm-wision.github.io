...
The DOY distribution of the test set is heavily summer skewed (Jul $=$ 517, Aug $=$ 668, Apr--Jun $=$ 607 of 2{,}105 quadrats), confirming that phenology should be most informative on summer flowering taxa. Figure~\ref{fig:test_doy_wheel} visualises this concentration as a calendar wheel: nearly nine out of every ten test quadrats fall between April and August, leaving the remaining seven months almost empty.
