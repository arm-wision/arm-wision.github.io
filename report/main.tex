...
\end{acknowledgments}
%%
%% Bibliography. The local ceurart.cls compatibility shim sets the
%% default style to plainnat; the canonical template would use
%% \bibliographystyle{ceurart}. Naming the style explicitly here makes
%% the choice visible at the top level.
