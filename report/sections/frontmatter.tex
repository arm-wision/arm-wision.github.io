...
Our system is BioCLIP~2.5 ViT-H/14 where
...
At inference each quadrat is split into a $4{\times}4$ grid of
...
the emitted species set.

Our best public Macro F1 is \textbf{0.41826} and our best private
