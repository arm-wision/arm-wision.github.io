...
essentially one model, which motivated---and explains the failure of---the search for orthogonal
evidence sources. Section~\ref{sec:longtail} examines why flattening the long tail hurt rather
than helped.
...
i003 takes the i002 manifest, augments the tail with $161{,}686$ validated images for the
$2{,}022$ species with fewer than one hundred training examples, and then caps every species at
...
i003 best reaching $0.40041$ public Macro F1 against $0.418265$ for the corresponding uncapped
