...
\caption{Model and training experiments (development trace). Public/private are the
best Kaggle Macro F1 for that experiment group; for the model rows the private value
is the best private of the group (which may come from a different submission than the
best public). Depth: Deep / Moderate / Shallow / Diagnostic / Dropped. Scores are not a
...
i003 & i002 + 500/species cap + extra GBIF & 0.400 & 0.402 & Deep & No & Capping/flattening hurt public; more clean data beat a balanced smaller set. \\
\bottomrule
\end{tabularx}
\end{table}
...
Sel. & selection rule (probT / top-$k$ / relT / gap) & 0.412 & 0.406 & Deep & Yes & Probability thresholding ($T{\sim}0.03$--$0.05$) beats top-$k$/gap/relT. \\
...
the best public score of $0.418265$. The three pivots (a triple-backbone classifier, a
...
\begin{itemize}
  ...
  ($0.418265$) is not our best private one ($0.40600$), and the i002+010 ensemble is
