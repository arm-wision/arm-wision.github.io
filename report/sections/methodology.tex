...
$4\times4$ grid of sixteen tiles, each roughly a quarter of the quadrat in width and height, so that most tiles contain only one
...
inference (Figure~\ref{fig:pipeline}), each quadrat is
