...
The deployed system is a single BioCLIP~2.5 ViT-H/14 backbone trained under the two-stage
...
$T{=}0.03$ is emitted, subject to $k_{\min}{=}2$ and $k_{\max}{=}10$. The two-resolution average is a single-checkpoint ensemble of the deployed i002 model, not a
