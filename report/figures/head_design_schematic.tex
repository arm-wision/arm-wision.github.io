...
\begin{scope}[shift={(0,0)}]
  ...
  % backbone
  \node[enc, minimum width=6.4cm, minimum height=8mm] (b010) at (3.2,0)
    {BioCLIP 2.5 ViT-H/14 encoder \;(last blocks + LN + proj trainable)};

  % shared MLP
  \node[mlp=Shar, minimum width=4.2cm] (s010) at (3.2,1.55)
    {Shared MLP \;(LN\,$\to$\,Linear\,$\to$\,GELU\,$\to$\,Dropout), 1024-d};
...
\begin{scope}[shift={(8.0,0)}]
  ...
  % backbone
  \node[enc, minimum width=5.2cm, minimum height=8mm] (bi02) at (2.6,0)
    {BioCLIP 2.5 ViT-H/14 encoder \;(last blocks + LN + proj trainable)};
