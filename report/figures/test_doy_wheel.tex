...
\begin{scope}[shift={(4.6, -2.8)}]
  \node[font=\sffamily\scriptsize, anchor=north west] at (0, 0.6)
    {\textbf{Counts}};
  \draw[fill=red!30, draw=red!80, line width=0.3pt] (0, 0.2) rectangle ++(0.25, 0.18);
  \node[anchor=west, font=\sffamily\scriptsize] at (0.32, 0.29)
    {Aug (668), exact};
  \draw[fill=orange!25, draw=orange!70, line width=0.3pt] (0, -0.05) rectangle ++(0.25, 0.18);
  \node[anchor=west, font=\sffamily\scriptsize] at (0.32, 0.04)
    {Jul (517), exact};
  \draw[fill=blue!18, draw=blue!55, line width=0.3pt] (0, -0.30) rectangle ++(0.25, 0.18);
  \node[anchor=west, font=\sffamily\scriptsize] at (0.32, -0.21)
    {Apr--Jun (607 total)};
  \draw[fill=gray!18, draw=gray!50, line width=0.3pt] (0, -0.55) rectangle ++(0.25, 0.18);
  \node[anchor=west, font=\sffamily\scriptsize] at (0.32, -0.46)
    {Sep--Mar (313 total)};
\end{scope}
