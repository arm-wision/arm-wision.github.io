...
% these additional commands in the next line ensure that the hfill moves it to the exact right end,
% otherwise there would be approx. 2 mm left over; at least in the article layout (it should work
% without these commands in the book layout in the first place).
{\parfillskip=0pt The introduction serves two purposes: \hfill (Not necessarily in this order.)\par}
\begin{compactenum}
